...
export const ATTRIBUTES = {
  ...
  NTB: {
    attributes: [
      ...
      { key: 'website', name: 'Website', kind: 'hyperlink', help: "The notified body's own website." },
    ],
    groups: [
      {
        name: 'Notification',
        ...
        attributes: [
          ...
          { key: 'register', name: 'Register', kind: 'hyperlink', help: "The body's entry in the Commission's register of notified bodies." },
        ...
        attributes: [
          {
            ...
            help: 'The protective measures related to the hazard when Eliminated was last set, recorded by the software.',
          },
    ...
    groups: [
      {
        ...
        attributes: [
          ...
          { key: 'muting', name: 'Muting or override', kind: 'multiline', help: 'Whether, how and when the safety function can be suspended, muted or overridden.' },
        ...
        attributes: [
          {
            ...
            help: 'The standard the safety function is designed to, which sets the levels offered.',
          },
      ...
      },
      {
        ...
        attributes: [
          ...
          { key: 'faultHandling', name: 'Fault reaction', kind: 'multiline', help: 'What the safety function does once a fault is found and the state it brings the machinery to.' },
          ...
          { key: 'faultRecovery', name: 'Fault recovery', kind: 'multiline', help: 'Whether a fault latches or clears itself, and how the safety function is reset and returns to service.' },
        ...
        attributes: [
          {
            ...
            help: 'Each time the verification was carried out, with when, by whom, whether it passed, and remarks.',
          },
        ],
      },
      { name: 'Notes', tab: true, attributes: [{ key: 'notes', name: 'Notes', kind: 'multiline' }] },
