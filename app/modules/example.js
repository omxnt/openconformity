...
export const EXAMPLE_PROJECT = {
  ...
  entities: [
    ...
    { id: 'CAS-001', type: 'CAS', parent: 'F-3', order: 0, attributes: { reference: 'Annex VI', title: 'Internal Control', description: 'Assessed by the manufacturer, without a notified body.' } },
    { id: 'CAS-002', type: 'CAS', parent: 'F-3', order: 1, attributes: { reference: 'Annex VII', title: 'EU Type-Examination', description: 'Assessed by a notified body for the safety component.' } },
    ...
    { id: 'HAZ-003', type: 'HAZ', parent: 'ELM-002', order: 2, attributes: { title: 'Unexpected Start-up', nature: 'Mechanical', description: 'The machine starts while someone is inside the guarding.' } },
    ...
    { id: 'HAZ-001', type: 'HAZ', parent: 'ELM-005', order: 0, attributes: { title: 'Moving Parts', nature: 'Mechanical', description: 'Rotating and translating parts in the drive area.' } },
    { id: 'HAZ-002', type: 'HAZ', parent: 'ELM-005', order: 1, attributes: { title: 'Stored Energy', nature: 'Mechanical', description: 'Energy held in the drive after the supply is removed.' } },
    { id: 'HAZ-006', type: 'HAZ', parent: 'ELM-005', order: 2, attributes: { title: 'Hot Surface', nature: 'Thermal', description: 'Surfaces of the drive that stay hot after a run.' } },
    ...
    { id: 'HAZ-004', type: 'HAZ', parent: 'ELM-008', order: 0, attributes: { title: 'Live Parts', nature: 'Electrical', description: 'Terminals that stay live when the main switch is off.' } },
    { id: 'HAZ-005', type: 'HAZ', parent: 'ELM-008', order: 1, attributes: { title: 'Short Circuit', nature: 'Electrical', description: 'A fault current in the electrical equipment.' } },
