...
/** @type {Array<[string, string, string, string|null]>}  id, entity type, name, parent */
const FOLDERS = [
  ['F-1', 'HAZ', 'Mechanical', null],
  ['F-2', 'HAZ', 'Electrical', null],
  ['F-3', 'HAZ', 'Thermal', null],
  ['F-4', 'ESR', 'Machinery Regulation (EU) 2023/1230', null],
  ['F-5', 'ESR', 'EMC Directive 2014/30/EU', null],
  ['F-6', 'STR', 'EN ISO 12100', null],
  ['F-7', 'STR', 'EN ISO 13849-1', null],
  ['F-8', 'STR', 'EN ISO 14119', null],
  ['F-9', 'STR', 'EN 60204-1', null],
];
...
const ENTITIES = [
  ...
  // --- Risk Assessment --------------------------------------------------
  ['HAZ-001', 'HAZ', { title: 'Moving Parts', group: 'Mechanical', description: 'Rotating and translating parts in the drive area.' }, 'F-1'],
  ['HAZ-002', 'HAZ', { title: 'Stored Energy', group: 'Mechanical', description: 'Energy held in the drive after the supply is removed.' }, 'F-1'],
  ['HAZ-003', 'HAZ', { title: 'Unexpected Start-up', group: 'Mechanical', description: 'The machine starts while someone is inside the guarding.' }, 'F-1'],
  ['HAZ-004', 'HAZ', { title: 'Live Parts', group: 'Electrical', description: 'Terminals that stay live when the main switch is off.' }, 'F-2'],
  ['HAZ-005', 'HAZ', { title: 'Short Circuit', group: 'Electrical', description: 'A fault current in the electrical equipment.' }, 'F-2'],
  ['HAZ-006', 'HAZ', { title: 'Hot Surface', group: 'Thermal', description: 'Surfaces of the drive that stay hot after a run.' }, 'F-3'],
  ...
  ['ESR-001', 'ESR', { title: '1.2.4.3 Emergency Stop', description: 'Machinery shall be fitted with an emergency stop device.' }, 'F-4'],
  ['ESR-002', 'ESR', { title: '1.3.7 Moving Parts', description: 'Moving parts shall prevent contact, or be guarded.' }, 'F-4'],
  ['ESR-003', 'ESR', { title: '1.4.2 Guards', description: 'Guards shall be robust, held in place and hard to defeat.' }, 'F-4'],
  ['ESR-004', 'ESR', { title: '1.5.1 Electricity', description: 'Electrically powered machinery shall prevent electrical hazards.' }, 'F-4'],
  ['ESR-005', 'ESR', { title: '1.6.3 Isolation of Energy Sources', description: 'Machinery shall provide a means to isolate its energy sources.' }, 'F-4'],
  ['ESR-006', 'ESR', { title: 'Annex I 1.1 Protection Requirements', description: 'Equipment shall not generate disturbance above the intended level.' }, 'F-5'],
  ['ESR-007', 'ESR', { title: 'Annex I 1.2 Immunity', description: 'Equipment shall work as intended in the presence of disturbance.' }, 'F-5'],

  ['STR-001', 'STR', { title: '5.4 Risk Estimation', description: 'How severity, exposure and avoidance combine into a risk.' }, 'F-6'],
  ['STR-002', 'STR', { title: '6.2 Inherently Safe Design', description: 'Measures that remove a hazard by design rather than by guarding.' }, 'F-6'],
  ['STR-003', 'STR', { title: '4.5 Required Performance Level', description: 'How the performance level required of a function is determined.' }, 'F-7'],
  ['STR-004', 'STR', { title: '6.2 Category Requirements', description: 'What the designated architecture has to achieve.' }, 'F-7'],
  ['STR-005', 'STR', { title: '5 Interlock Selection', description: 'How an interlocking device is chosen for a guard.' }, 'F-8'],
  ['STR-006', 'STR', { title: '7 Prevention of Defeat', description: 'How defeat with a spare actuator is prevented.' }, 'F-8'],
  ['STR-007', 'STR', { title: '9.2 Stop Categories', description: 'The stop categories, and when each one applies.' }, 'F-9'],
  ['STR-008', 'STR', { title: '5.3 Supply Disconnecting Device', description: 'The device that isolates the electrical supply.' }, 'F-9'],
...
export function buildExampleModel() {
  ...
  for (const [id, typeCode, name, parent] of FOLDERS) {
    addFolder(model, typeCode, name, parent, id);
  }
