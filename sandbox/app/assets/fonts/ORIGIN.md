...
heading styles, Regular 400 for the body and label styles, and SemiBold 600
for the heading styles. The interface reaches no further up the scale than
`$heading-03`, which is Regular, so Light is not vendored. Medium 500 is not
a weight the scale uses, and is not vendored either.

License: SIL Open Font License 1.1, see LICENSE.txt. Applies to both
families.
