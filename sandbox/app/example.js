...
export const EXAMPLE_PROJECT = {
  ...
  entities: [
    ...
    { id: 'SCN-001', type: 'SCN', parent: 'F-11', order: 0, attributes: { title: 'Contact with Moving Parts', hazardZone: 'Drive Unit', hazardousEvent: 'Operator reaches into the drive area to clear a jam. Drive starts while the hand is in the hazard zone.', consequence: 'Crushing of the hand.' } },
    { id: 'SCN-002', type: 'SCN', parent: 'F-11', order: 1, attributes: { title: 'Electric Shock', hazardZone: 'Electrical Cabinet', hazardousEvent: 'Technician works in the cabinet with the supply connected. Contact with a live part.', consequence: 'Electric shock.' } },
    { id: 'SCN-003', type: 'SCN', parent: 'F-11', order: 2, attributes: { title: 'Start-up During Maintenance', hazardZone: 'Guarded Area', hazardousEvent: 'Technician inside the guarding with the machine not isolated. Machine restarts.', consequence: 'Crushing.' } },
    { id: 'SCN-004', type: 'SCN', parent: 'F-11', order: 3, attributes: { title: 'Burn on Hot Surface', hazardZone: 'Drive Unit', hazardousEvent: 'Cleaner works close to the drive after a production run. Contact with a hot surface.', consequence: 'Burn to the hand.' } },
