...

{
  ...
  deepEqual(
    ...
    ['ELM:Diagram', 'TSK:Conditions', 'LEG:Applicability', 'HST:Applicability', 'OSP:Applicability', 'SCN:Risk', 'PRM:Diagram', 'SAF:Behaviour', 'SAF:Characteristics', 'SAF:Fault handling', 'SAF:Diagram', 'ESR:Guidance', 'ESR:Applicability', 'HSR:Guidance', 'HSR:Applicability', 'OSR:Guidance', 'OSR:Applicability', 'VER:Result'],
    "the tabs in the model beside the notes: a task's conditions, every verdict, a scenario's risk, a safety function's behaviour, characteristics and faults, a verification's result, and a drawing on an element, a measure and a function"
  );
