...

{
  ...
  ok(readFile('../docs/attributes.md').includes('| set | Any number of the values in the Values column'), 'the document defines the set kind');
  ...
  ok(readFile('../docs/attributes.md').includes('The editor shows it as the first cell of the type\'s own tab'), 'as the document now allows');
...

{
  ...
  ok(readFile('../docs/attributes.md').includes('#### Applicability `tab`'), 'the document tags a group as a tab');
...
{
  const doc = readFile('../docs/attributes.md');
