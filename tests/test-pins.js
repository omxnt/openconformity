...

{
  ...
  ok(readFile('../app/modules/library.js').includes("togglePick(library, picks, node.id, alone);") && readFile('../app/modules/library.js').includes("alone = event.altKey;") && readFile('../app/modules/library.js').includes("text: 'Alt and click picks one entity by itself.'"), 'Alt and click on a box picks that one entity by itself, and the picker says so');
