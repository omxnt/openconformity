...

{
  ...
  ok(about.includes("['JGraph Ltd', 'Maker and trademark holder of draw.io, not affiliated', [link('https://www.drawio.com/trust/', 'Privacy')]]") && about.includes("link('https://www.drawio.com/trust/terms-of-use/', 'Terms of use')"), "About credits draw.io's maker, links its terms and privacy, and disclaims affiliation, since the name is their trademark");
